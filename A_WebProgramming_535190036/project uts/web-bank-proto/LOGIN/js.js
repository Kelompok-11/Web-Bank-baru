...
function Deposit() {
    ...
    document.getElementById("balance").innerHTML =prbalance;  
    document.getElementById("notification") .innerHTML= "Success. You deposii "+input+" IDR on balance";
    }
}
...
function Withdrawal() {
	...
	if (input<0) {
        ...
        document.getElementById("notification").innerHTML = "Success withdrawal " + input + " IDR";
        prbalance=account[success];
        document.getElementById("balance").innerHTML =prbalance;
...
function Transfers(){
	...
	if ((input == id[i] && inputmoney>0 && account[success]-inputmoney>0)){
		...
		document.getElementById("errortick").style.display = 'none';
		document.getElementById("balance").innerHTML = prbalance;
		document.getElementById("notification") .innerHTML= "Success. You have send the money "+inputmoney+" IDR in account "+id[i];
	}else{
		document.getElementById("errortick").style.display = 'block';
    	document.getElementById("notick").style.display = 'none';
	}
